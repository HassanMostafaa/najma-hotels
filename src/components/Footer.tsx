        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-amber-100/60">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+971123456789" className="hover:text-amber-300 transition-colors">
                  +971 123 456 789
                </a>
              </li>
              <li className="flex items-center">
                ...
                <a href="mailto:info@najmahotels.com" className="hover:text-amber-300 transition-colors">
          ...
          <div>
            ...
            <div className="flex space-x-6">
              {[
                { name: "Twitter", icon: "M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z", url: "https://twitter.com/najmahotels" },
                { name: "Facebook", icon: "M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z", url: "https://facebook.com/najmahotels" },
                { name: "Instagram", icon: "M16 11.37A4 4 0 1112.63 8 4 4 0 0116 11.37zm1.5-4.87h.01M22 12c0 5.523-4.477 10-10 10S2 17.523 2 12 6.477 2 12 2s10 4.477 10 10z", url: "https://instagram.com/najmahotels" },
              ].map((social) => (
                <a
                  key={social.name}
                  href={social.url}
